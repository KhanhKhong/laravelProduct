...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-8">
            <h1 class="page-heading">{{ isset($editItems) ? 'Edit contact' : 'Create contact' }}</h1>
        </div>
        <div class="col-lg-2"></div>
        <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="col-lg-10">
            <div class="panel panel-default">
                <form action="{{ route('update_contact') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="text" hidden="true" name="contact_id" value="{{ isset($editItems) ? $editItems->id : '' }}">
                        ...
                        <div class="row">
							<div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="editor2" class="ckeditor" name="information">{{ isset($editItems) ? $editItems->information : '' }}</textarea>   
                                </div> 
							</div>
                        </div>
                        <br>
